...
class BitcoinsAndEurosTest {
	...
	public void testExampleA() {
		...
		Assertions.assertEquals(4037.5, Solution.optimalTrade(t, r), 0.001);
	}
	...
	public void testExampleB() {
		...
		Assertions.assertEquals(210.35103769828928, Solution.optimalTrade(t, r), 1e-6);
	}
	...
	public void testExampleBExtended() {
		...
		Assertions.assertEquals(222.01278382581648, Solution.optimalTrade(t, r), 1e-6);
	}
	...
	public void testExampleDontBuyMore() {
		...
		Assertions.assertEquals(48.45, Solution.optimalTrade(t, r), 0.001);
	}
